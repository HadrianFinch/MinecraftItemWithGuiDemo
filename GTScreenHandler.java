...
public class GTScreenHandler extends ScreenHandler
{
    ...
    public GTScreenHandler(int syncId, PlayerInventory playerInventory, ScreenHandlerContext context)
    {
        ...
        {
            // Write the inventory data back to the nbt of the item when it changes
            @Override
        ...
        for (j = 0; j < 9; ++j)
        {
            this.addSlot(new Slot(playerInventory, j, 8 + j * 18, 161 + i)
            {
                ...
                {
                    // you shouldnt be able to interact with the item that is providing the GUI.
    ...
    {
        // TODO: make real
        // NOTE: Not sure what usually goes here, so I just said true
        return true;
    }
    ...
    public ItemStack quickTransfer(PlayerEntity player, int fromIndex)
    {
        ...
        if (slot != null && slot.hasStack())
        {
            ...
            {
                // Move from gui inv to player inv
